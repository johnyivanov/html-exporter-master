...
import de.dfs.html.converter.ss.DefaultTableCellReference;
import de.dfs.html.converter.ss.Dimension;
import de.dfs.html.converter.ss.Function;
import de.dfs.html.converter.ss.RangeReferenceTracker;
...
public abstract class AbstractTableCellWriter implements TableCellWriter {
    ...
    private int outerColumnIndex;
    private int innerColumnIndex;

    public AbstractTableCellWriter() {
        tracker = new RangeReferenceTracker();
    }

    public void writeCell(Element element, int rowIndex, int columnIndex,boolean isOuterTable) {
        if (isOuterTable) {
            ExcelExporter.globalColumnIndex++;
    ...
    public String getElementText(Element element) {
        String text = element.wholeText().replace(System.lineSeparator(),"");
